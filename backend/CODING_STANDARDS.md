...
Единый экземпляр axios — всегда используй настроенный экземпляр с baseURL и интерцепторами
Инициализация данных — всегда вызывай загрузку при наличии токена
Обработка ответов API — всегда проверяй структуру и гарантируй массив